                    ...
                    <div class="modal-body">
                        <form method="post" action="${pageContext.request.contextPath}/admin">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="classroomID" class="form-control" type="text" name="classroomID" value="${classroom.classroomID}" required>
                            </div>
                            <div class="mb-3">
                                <label for="name" class="form-label">Tên lớp học</label>
                                <input id="name" class="form-control" type="text" name="name" value="${classroom.name}" required>
                            </div>
                            <div class="mb-3">
                                <label for="teacherID" class="form-label">Mã GV</label>
                                <input id="teacherID" class="form-control" type="text" name="teacherID" value="${classroom.teacherID}" required>
                            </div>
