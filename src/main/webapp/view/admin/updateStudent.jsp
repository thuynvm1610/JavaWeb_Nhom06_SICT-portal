                                ...
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <form method="get" action="admin">
                                        <div style="display: flex;">
                                            ...
                                            <input style="outline: none; border: none; border-bottom-left-radius: 6px; border-top-left-radius: 6px; padding-left: 10px;" type="text" name="studentID" placeholder="Nhập mã sinh viên..."/>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div style="display: flex; gap: 5px;">
                                                                    ...
                                                                    <form method="get" action="admin">
                                                                        <input type="hidden" name="action" value="deleteStudentForm"/>
                                                                        <input type="hidden" name="studentID" value="${s.studentID}"/>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Chỉnh sửa thông tin sinh viên <strong><c:out value="${student.studentID}"/></strong></h5>
